...
import scsbre.engine.rules.HasCorrectHireVatCalculation;
import scsbre.model.ClaimStatus;
import scsbre.tests.data.TestClaim;
import scsbre.tests.sample.*;


public class Rule009HasCorrectHireVatCalculationTest extends TestCase {
    ...
    public void testSkipped_OnOffFlag() throws IOException {
        ...
        claim.getChoBand().setHasCorrectHireVatCalculation(false);
    ...
    public void testPassed() throws IOException {
        ...
        ClaimInfo claim = getTestClaim();
        claim.getChoBand().setHasCorrectHireVatCalculation(true);
    ...
    public void testFailled() throws IOException {
        ...
        // SET INVOICE
        claim.getInvoice().setHireNet(new BigDecimal("100.00"));
        claim.getInvoice().setHireVat(new BigDecimal("16.00"));
        // claim.getInvoice().setHireGross(new BigDecimal("135.00"));

        RuleEvaluation rv = new HasCorrectHireVatCalculation().applyToClaim(claim);

        assertTrue(RuleEvaluationResult.RuleFailed == rv.getResult());
        assertTrue(rv.getRelatedRule().getNarrative().equalsIgnoreCase("Hire VAT calculation is incorrect."));
