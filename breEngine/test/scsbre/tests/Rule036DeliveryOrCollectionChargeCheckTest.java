...
import scsbre.engine.rules.DeliveryOrCollectionChargeCheck;
import scsbre.model.ClaimStatus;
import scsbre.tests.data.TestClaim;
import scsbre.tests.sample.*;


public class Rule036DeliveryOrCollectionChargeCheckTest extends TestCase {
    ...
    public void testSkipped_OnOffFlag() throws IOException {
        ...
        claim.getChoBand().setDeliveryOrCollectionChargeCheck(false);
        RuleEvaluation rv = new DeliveryOrCollectionChargeCheck().applyToClaim(claim);
    ...
    public void testPassed_zero() throws IOException {
        ...
        ClaimInfo claim = getTestClaim();
        claim.getChoBand().setDeliveryOrCollectionChargeCheck(true);
    ...
    public void testFailled() throws IOException {
        ...
        ClaimInfo claim = getTestClaim();
        claim.getChoBand().setDualControlChargeCheck(true);

        claim.getInvoice().setDeliveryCollectionFee(new BigDecimal("0.99"));
