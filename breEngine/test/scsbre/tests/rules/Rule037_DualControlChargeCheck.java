...
import scsbre.engine.rules.DualControlChargeCheck;
import scsbre.model.ClaimStatus;
import scsbre.tests.rules.data.TestClaim;
import scsbre.tests.sample.*;


public class Rule037_DualControlChargeCheck extends TestCase {
    ...
    public void testSkipped_OnOffFlag() throws IOException {
        ...
        claim.getChoBand().setDualControlChargeCheck(false);
