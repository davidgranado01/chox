...
public class Rule010_HasCorrectRepairVatCalculation extends TestCase {
    ...
    public void testSkipped_OnOffFlag() throws IOException {
        ...
        claim.getChoBand().setHasCorrectRepairVatCalculation(false);
...
// TODO: HasCorrectRepairVatCalculation
    public void testPassed() throws IOException {

        ClaimInfo claim = getTestClaim();
        claim.getChoBand().setHasCorrectRepairVatCalculation(true);
