...
import scsbre.engine.rules.NonStandardRiskInsurancePremiumCheck;
import scsbre.model.ClaimStatus;
import scsbre.tests.data.TestClaim;
import scsbre.tests.sample.*;


public class Rule030NonStandardRiskInsurancePremiumCheckTest extends TestCase {
    ...
    public void testSkipped_OnOffFlag() throws IOException {
        ...
        claim.getChoBand().setNonStandardRiskInsurancePremiumCheck(false);
    ...
    public void testPassed_zero() throws IOException {
        ...
        ClaimInfo claim = getTestClaim();
        claim.getChoBand().setNonStandardRiskInsurancePremiumCheck(true);

        claim.getInvoice().setNonStandardInsurancePremiumFee(new BigDecimal("0.00"));
    ...
    public void testFailled() throws IOException {
        ...
        claim.getInvoice().setNonStandardInsurancePremiumFee(new BigDecimal("0.99"));
