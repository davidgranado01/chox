...
function onOpenAbout(){
    ...
    msg = msg + "<span class='acountCopyright'>Copyright Message: &copy;2011 Sherwood Compliance Services Ltd</span><br/><br/>";
    msg = msg + "<span class='acountVersionNumber'>V5.3.1 - 20111107</span><br/><br/>";
