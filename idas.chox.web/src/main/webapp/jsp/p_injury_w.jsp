...
<script type="text/javascript">
    ...
    $(function(){
        ...
        var form = $("form#formUpdateInjuryt");
    ...
    <fieldset class="x-fieldset">
        ...
        <div style="display:none" class="form-container">
            ...
            <div class="chox-form-item">
                ...
                <input type="text" class="chox-ttxt" id="INJEmail" name="email" value="<s:property value="email" />" />
            </div>
            ...
            <div id="InjuryMessageBox" class="action-error-msg"></div>
        </div>
    </fieldset>
</form>