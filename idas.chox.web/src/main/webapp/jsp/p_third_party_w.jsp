...
<script type="text/javascript">
    ...
    $(function(){
        ...
        var form = $("form#formUpdateThirdParty");
        ...
        form.validate(
        {
            ...
            messages: {
                title: { required:"You must supply a value for 'Title'"},
                firstName : {required:"You must supply a value for 'First Name'"},
                lastName: { required:"You must supply a value for 'Last Name'"},
                insurerId: { min: "You must select an Insurer"},
                policyNumber: { required:"You must supply a value for 'Policy Number'"},
...
<form id="formUpdateThirdParty" action="<%=request.getContextPath()%>/prv/p/updateThirdParty.action" class="XXentity-form">
    ...
    <fieldset class="x-fieldset">
        ...
        <div style="display:none" class="form-container">            
            ...
            <div class="chox-form-item">
                <label class="chox-form-std-label">Insurer<span class="mandatory">*</span></label>
