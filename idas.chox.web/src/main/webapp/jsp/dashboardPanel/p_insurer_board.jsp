...
<table cellpadding="0" cellspacing="0" class="dashboard" style="width:100%;" border="0">
    ...
    <tr><th nowrap><label id="tip4">Number of Claims Awaiting to be Processed</label></th>          <td nowrap>-</td>                                                                                                           <td nowrap>-</td>                                                                                                       <td nowrap><label class="dbValue"><s:property value="cData.noOfClaimsAwaitingToBeProcessed"/></label></td></tr>
