...
<script type="text/javascript">
    ...
    Ext.onReady(function(){
            ...
            new Ext.ToolTip({target: 'tip6',html: 'Invoices uploaded against selected Insurer(s)'});
            ...
            new Ext.ToolTip({target: 'tip14',html: 'Number of Invoices Awaiting Liability Resolution for  by insurer'});
            ...
            new Ext.ToolTip({target: 'tip17',html: 'Value of invoices withdrawn for selected Insurer(s) where value is using Total To Pay amount'});
            new Ext.ToolTip({target: 'tip18',html: 'Number of claims where invoice payments have been made by Insurer(s)'});
            new Ext.ToolTip({target: 'tip19',html: 'Value of claims where invoice payments(using Total To Pay amount) have been made by Insurer(s) '});
            new Ext.ToolTip({target: 'tip20',html: 'Number of claims where payment has been received'});
            new Ext.ToolTip({target: 'tip21',html: 'Value of claims where payment(using Total To Pay amount) has been received'});
            Ext.QuickTips.init();
    });    
...
<table cellpadding="0" cellspacing="0" class="dashboard" style="width:100%;" border="0">
    ...
    <tr><th nowrap><label id="tip4">Number of Claims Awaiting to be Processed</label></th>          <td nowrap><label class="dbValue"><s:property value="w2DData.noOfClaimsAwaitingToBeProcessed"/></label></td>                   <td nowrap><label class="dbValue"><s:property value="m2DData.noOfClaimsAwaitingToBeProcessed"/></label></td>        <td nowrap><label class="dbValue"><s:property value="cData.noOfClaimsAwaitingToBeProcessed"/></label></td></tr>
