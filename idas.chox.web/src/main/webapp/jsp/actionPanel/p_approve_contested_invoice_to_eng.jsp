...
//        actionPanel.registerAction(action);
        ...
        if($("#invoiceReferredByEngForm").valid()){
            ...
            if (action=='rejectInvoice') {
                ...
                else if(reasonOfRejection != <s:property value="invoiceLiabilityDisputeReasonId" /> && !Ext.MessageBox.confirm('Confirm', 'Are you sure you want to reject this claim?',function(btn){if(btn=='yes'){$("form#invoiceReferredByEngForm").submit();}else{return false;}})){
                    return;
                }
            }
            else{
