                    ...
                    <table class="status-table">
                        <tr>
                            <td>
                                ...
                                <input type="button" id="MAUICNUpdateSupplierReferenceNumberButtonId" value="Update Supplier Reference Number" onclick="return doSubmitSupplierReferenceNumber();"/>
                            </td>
                            <td></td><td></td>
                        </tr>
                    </table>
