                    ...
                    <table class="status-table">
                        <tr>
                            <td>
                                ...
                                <input type="submit" id="MAUICNUpdateCustomerClaimNumberButtonId"value="Update Customer Claim Number" onclick="event.preventDefault(); doSubmitCustomerClaimNumber();"/>
                            </td>
                            <td></td><td></td>
                        </tr>
                    </table>
