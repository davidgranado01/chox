                                        ...
                                        <td>
                                            ...
                                            <s:elseif test="interimPaymentReceivedAmount != null && interimPaymentReceivedAmount > 0">
                                                <div class="chox-form-item">
                                                    ...
                                                    <label class="std-data-ro-red-invrecalc">(£<s:property value="interimPaymentReceivedAmount" /> Received, £<s:property value="partialInterimPayment" /> Not Received)</label><br/>
