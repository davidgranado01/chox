...
<fieldset class="x-fieldset">
    ...
    <div style="display:none" class="form-container">
        ...
        <div class="chox-form-item">
            ...
            <label class="std-data-ro"><s:property value="automaticQty" /></label></div>
        <div class="chox-form-item">
            <label class="std-label-ro">
                Sat Nav Fee</label>
        ...
        <div class="chox-form-item">
            ...
            <label class="std-data-ro"><s:property value="satNavQty" /></label></div>
        <div class="chox-form-item">
            <label class="std-label-ro">
                Estate Fee</label>
        ...
        <div class="chox-form-item">
            ...
            <label class="std-data-ro"><s:property value="babySeatQty" /></label></div>
        <div class="chox-form-item">
            <label class="std-label-ro">
                Tow Bars Fee</label>
        ...
        <div class="chox-form-item">
            ...
            <label class="std-data-ro"><s:property value="towBarsQty" /></label></div>
        <div class="chox-form-item">
            <label class="std-label-ro">
        ...
        <div class="chox-form-item">
            ...
            <label class="std-data-ro"><s:property value="nonStandardInsurancePremiumQty" /></label></div>
        <div class="chox-form-item">
            <label class="std-label-ro">
                Admin Fee</label>
        ...
        <div class="chox-form-item">
            ...
            <label class="std-data-ro"><s:property value="adminQty" /></label></div>
        <div class="chox-form-item">
            <label class="std-label-ro">
                Roof Rack Fee</label>
        ...
        <div class="chox-form-item">
            ...
            <label class="std-data-ro"><s:property value="roofRackQty" /></label></div>
        <div class="chox-form-item">
            <label class="std-label-ro">
        ...
        <div class="chox-form-item">
            ...
            <label class="std-data-ro"><s:property value="dualControlQty" /></label></div>
        <div class="chox-form-item">
            <label class="std-label-ro">
        ...
        <div class="chox-form-item">
            ...
            <label class="std-data-ro"><s:property value="deliveryCollectionQty" /></label></div>
    </div>
</fieldset>
