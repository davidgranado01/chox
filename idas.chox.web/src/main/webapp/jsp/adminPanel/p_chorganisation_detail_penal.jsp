         ...
         function onSubmitResponseReceived(responseText, statusText){
            ...
            if(response && response.isValid){
                ...
                if(response.resultType == "New" && response.result)
                {
                    ...
                    $("#admin_param_panel").load("<%= request.getContextPath()%>/prv/p/updateChorganisationDetailPanel.action?objectId=" + newObjectId+uniqeToken());
...
<form id="formUpdateChorganisationDetail" action="<%= request.getContextPath()%>/prv/p/updateChorganisationDetail.action" class="XXentity-form" method="post" onsubmit="return true;">
