    ...
    Ext.onReady(function(){
        ...
        ipWhitelist_gridviewGrid = new Ext.grid.GridPanel({
            ...
            columns: [
                ...
                {header: "Discription",  width: 90, dataIndex: 'description', sortable: true, resizable: true,editor: {xtype: 'textfield',allowBlank: false, emptyText  : 'Discription is required'}},
