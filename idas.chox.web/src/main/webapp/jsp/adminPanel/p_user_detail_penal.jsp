...
<script language="JavaScript">
    ...
    function doCancelBack(){
        $("#admin_param_panel").load("<%= request.getContextPath()%>/prv/p/loadAdminPanel.action?adminPanelName=" + selectedPanel + "&selectOrgTypeId="+<s:property value="orgTypeId"/>+uniqeToken());
    }
