...
<fieldset class="x-fieldset">
    ...
    <div style="display:none" class="form-container" id="injuryRId">
        <table class="chox-table-form">
            <tr>
                <td><label class="std-label-ro">Name</label></td>
                <td>&nbsp;</td>
                <td><label class="std-data-ro"><s:property value="name" /></label></td>
            </tr>
            <tr>
                <td><label class="std-label-ro">Address 1</label></td>
                <td>&nbsp;</td>
                <td><label class="std-data-ro"><s:property value="address1" /></label></td>
            </tr>
            <tr>
                <td><label class="std-label-ro">Address 2</label></td>
                <td>&nbsp;</td>
                <td><label class="std-data-ro"><s:property value="address2" /></label></td>
            </tr>
            <tr>
                <td><label class="std-label-ro">Address 3</label></td>
                <td>&nbsp;</td>
                <td><label class="std-data-ro"><s:property value="address3" /></label></td>
            </tr>
            <tr>
                <td><label class="std-label-ro">Address 4</label></td>
                <td>&nbsp;</td>
            ...
            <tr>
                <td><label class="std-label-ro">Telephone Day</label></td>
                <td>&nbsp;</td>
                <td><label class="std-data-ro"><s:property value="telephoneDay" /></label></td>
            </tr>
            <tr>
                <td><label class="std-label-ro">Telephone Evening</label></td>
                <td>&nbsp;</td>
                <td><label class="std-data-ro"><s:property value="telephoneEvening" /></label></td>
            </tr>
            <tr>
                <td><label class="std-label-ro">Email</label></td>
                <td>&nbsp;</td>
