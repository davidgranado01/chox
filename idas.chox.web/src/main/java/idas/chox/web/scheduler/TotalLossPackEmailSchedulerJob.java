...
public class TotalLossPackEmailSchedulerJob extends PdfEmailSchedulerJob {

    private static final Logger LOG = LoggerFactory.getLogger(TotalLossPackEmailSchedulerJob.class);
    private ClaimService claimService;
    private AttachmentService attachmentService;
    private AttachmentTypeService attachmentTypeService;
    
    private String REG_ALPHANUMERIC = "^([\\d]|[a-z]|[A-Z]).*$";
    public static final String JOB_NAME = "TOTALLOSS_PACK";
