...
public class InsurerDashboardBuilder {
    ...
    public DashBoardViewData getWeekToDate() {
        ...
        sb.append("(select avg(avg_inv_payment_time_w) as avg_inv_time from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as Avg_InvPaymentTime, ");
        sb.append("(select sum(num_manual_invoices_submitted_w) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_manual_InvoicesSubmitted, ");
        sb.append("(select sum(val_manual_invoices_submitted_w) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_manual_InvoicesSubmitted, ");
        sb.append("(select sum(num_manual_invoices_paid_w) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_manual_InvoicesPaid, ");
        sb.append("(select sum(val_manual_invoices_paid_w) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_manual_InvoicesPaid, ");
        sb.append("(select sum(num_manual_invoices_closed_w) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_manual_InvoicesClosed, ");
        sb.append("(select sum(val_manual_invoices_closed_w) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_manual_InvoicesClosed, ");
        sb.append("(select sum(num_invoices_awaiting_litigation_outcome_w) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_InvoicesAwaitingLitigationOutcome, ");
        sb.append("(select sum(val_invoices_awaiting_litigation_outcome_w) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_InvoicesAwaitingLitigationOutcome ");
    ...
    public DashBoardViewData getMonthToDate() {
        ...
        sb.append("(select avg(avg_inv_payment_time_m) as avg_inv_time from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as Avg_InvPaymentTime, ");
        sb.append("(select sum(num_manual_invoices_submitted_m) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_manual_InvoicesSubmitted, ");
        sb.append("(select sum(val_manual_invoices_submitted_m) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_manual_InvoicesSubmitted, ");
        sb.append("(select sum(num_manual_invoices_paid_m) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_manual_InvoicesPaid, ");
        sb.append("(select sum(val_manual_invoices_paid_m) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_manual_InvoicesPaid, ");
        sb.append("(select sum(num_manual_invoices_closed_m) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_manual_InvoicesClosed, ");
        sb.append("(select sum(val_manual_invoices_closed_m) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_manual_InvoicesClosed, ");
        sb.append("(select sum(num_invoices_awaiting_litigation_outcome_m) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_InvoicesAwaitingLitigationOutcome, ");
        sb.append("(select sum(val_invoices_awaiting_litigation_outcome_m) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_InvoicesAwaitingLitigationOutcome ");
        sb.append("from insurer insurer where insurer.id = :pInsId ");
        return build(queryParameters, sb.toString());
    }
    ...
    public DashBoardViewData getCumulative() {
        ...
        sb.append("(select avg(avg_inv_payment_time_c) as avg_inv_time from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as Avg_InvPaymentTime, ");
        sb.append("(select sum(num_manual_invoices_submitted_c) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_manual_InvoicesSubmitted, ");
        sb.append("(select sum(val_manual_invoices_submitted_c) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_manual_InvoicesSubmitted, ");
        sb.append("(select sum(num_manual_invoices_paid_c) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_manual_InvoicesPaid, ");
        sb.append("(select sum(val_manual_invoices_paid_c) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_manual_InvoicesPaid, ");
        sb.append("(select sum(num_manual_invoices_closed_c) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_manual_InvoicesClosed, ");
        sb.append("(select sum(val_manual_invoices_closed_c) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_manual_InvoicesClosed, ");
        sb.append("(select sum(num_invoices_awaiting_litigation_outcome_c) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as n_InvoicesAwaitingLitigationOutcome, ");
        sb.append("(select sum(val_invoices_awaiting_litigation_outcome_c) as no_count from dashboard where (chorganisation_id = :pChorganisationId or :pChorganisationId < 0) and (workgroup_id = :pWorkgroupId or :pWorkgroupId < 0) and (claim_owner_id = :pClaimOwnerId or :pClaimOwnerId < 0) and insurer_id = insurer.id and complete=true) as v_InvoicesAwaitingLitigationOutcome ");
        sb.append("from insurer insurer where insurer.id = :pInsId ");
        return build(queryParameters, sb.toString());
    }
