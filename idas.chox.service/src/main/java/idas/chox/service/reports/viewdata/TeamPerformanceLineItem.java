...
public class TeamPerformanceLineItem {

    private static final Logger LOG = LoggerFactory.getLogger(TeamPerformanceLineItem.class);
    private String site;
    private String team;
    ...
    public static TeamPerformanceLineItem getObject(Map data) {
        TeamPerformanceLineItem result = new TeamPerformanceLineItem();
