...
public class ClaimsGridExportReport {
    ...
    public List<ExcelClaim> getExcelClaims(List<Integer> ids, Boolean isIns) {
        ...
        sb.append("select")
            ...
            .append(" c.final_review_cho, c.final_review_ins, wuc.last_name || ' ' || wuc.first_name as claim_supplier_owner, c.remaining_sla_days_str, c.is_invoice_review_required, c.invoice_review_reason,")
