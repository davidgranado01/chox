...
public class ClaimsGridExportReport {
    ...
    public List<ExcelClaim> getExcelClaims(List<Integer> ids, Boolean isIns) {
        ...
        sb.append("select")
            ...
            .append(" ihmd.tp_reported_incident_to_tpi_date as ihmd.tp_reported_incident_to_tpi_date, ihmd.repair_book_in_date as ihmd_repair_book_in_date, ihmd.parts_received_date as ihmd.parts_received_date,  ihmd.repair_authorised_date as ihmd_repair_authorised_date,")
            .append(" ihmd.total_loss_report_sent_to_us_date as ihmd.total_loss_report_sent_to_us_date, ihmd.repair_commenced_date as ihmd_repair_commenced_date, ihmd.inspection_booked_date as ihmd_inspection_booked_date, ihmd.inspection_date as ihmd_inspection_date,")
