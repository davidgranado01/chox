...
public class ClaimsGridExportReport {
    ...
    public List<ExcelClaimCycle> getExcelClaimCycle(List<Integer> ids) {
        ...
        sb.append("select ")
            ...
            .append(" case when ins.name is not null then")
            .append("    case when wu.hashed then 'GDPR: data removed (' || ins.name || ')' else wu.first_name || ' ' || wu.last_name || ' (' || ins.name || ')' end")
            .append("       else case when cho.name is not null then")
            .append("         case when wu.hashed then 'GDPR: data removed (' || cho.name || ')' else wu.first_name || ' ' || wu.last_name || ' (' || cho.name || ')' end")
            .append("            else case when wu.hashed then 'GDPR: data removed' else wu.first_name || ' ' || wu.last_name end end end as modifiedby,")
    ...
    public List<ExcelComment> getExcelComments(List<Integer> ids) {
        ...
        sb.append("select ")
            ...
            .append("       else case when cho.name is not null then")
            .append("         case when wu.hashed then 'GDPR: data removed (' || cho.name || ')' else wu.first_name || ' ' || wu.last_name || ' (' || cho.name || ')' end")
            .append("            else case when wu.hashed then 'GDPR: data removed' else wu.first_name || ' ' || wu.last_name end end end as createdby,")
    ...
    public List<ExcelInvoice> getExcelInvoices(List<Integer> ids) {
        ...
        sb.append("select ")
            ...
            .append(" io.storage_recovery_net as originalstoragerecoverynet,io.storage_recovery_vat as originalstoragerecoveryvat, io.storage_recovery_gross as originalstoragerecoverygross, i.storage_recovery_net as storagerecoverynet, i.storage_recovery_vat as storagerecoveryvat, i.storage_recovery_gross as storagerecoverygross,")
            ...
            .append(" inner join vehicle_hire vh on c.vehicle_hire_id = vh.id")
            .append(" where c.id in (");
    ...
    public List<ExcelClaim> getExcelClaims(List<Integer> ids, Boolean isIns) {
        ...
        sb.append("select")
            ...
            .append(" vh_vc.name as vh_vehicle_class_name, vhn.name as vhn_vehicle_original_class, vh.days_original as vh_original_no_days_hire, vh.rental_start as vh_rental_start, vh.rental_end as vh_rental_end, vh.days as vh_days,")
            ...
            .append(" ihmd.tp_reported_incident_to_tpi as ihmd_tp_reported_incident_to_tpi, ihmd.repair_book_in_date as ihmd_repair_book_in_date, ihmd.parts_received as ihmd_parts_received,  ihmd.repair_authorised_date as ihmd_repair_authorised_date,")
            .append(" ihmd.tl_report_sent_to_us as ihmd_tl_report_sent_to_us, ihmd.repair_commenced_date as ihmd_repair_commenced_date, ihmd.inspection_booked_date as ihmd_inspection_booked_date, ihmd.inspection_date as ihmd_inspection_date,")
            ...
            .append(" ihmd.total_loss_offer_accepted as ihmd_total_loss_offer_accepted, ihmd.total_loss_payment_issued as ihmd_total_loss_payment_issued, ihmd.payment_type as ihmd_payment_type,")
            .append(" ihmd.total_loss_payment_received as ihmd_total_loss_payment_received, ihmd.labour_rate as ihmd_labour_rate, ihmd.labour_hour as ihmd_labour_hour,")
            ...
            .append(" ivh_vc.name as ihmd_replacement_vehicle_class, ivh.rental_start as ihmd_rental_start, ivh.rental_end as ihmd_rental_end")
            .append(" from claim c")
            .append("     join chorganisation cho on (c.chorganisation_id = cho.id)")
            ...
            .append("     left outer join vehicle_class vhn on (vhn.id = vh.vehicle_class_original_id )")
