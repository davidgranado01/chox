...
//            boolean success = CalcHelper.LessThanOrEqualTo(actual, expected);
            ...
            if (success) {
                ...
                narrative = "The CHO is charging more than the Invoice-date VAT rate of " + CalcHelper.getVatRate(claim.getVehicleHire().getHireEnd()).multiply(new BigDecimal(100.0)).setScale(2, BigDecimal.ROUND_HALF_DOWN) + "% for the Hire.";
            }
