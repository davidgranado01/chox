...
public class TotalLossPeriodWhereCHOSendingAndDealingPAVAndVehicleNotRoadworthyCheck implements IBusinessRule {
    ...
    public RuleEvaluation applyToClaim(Claim claim) {
        ...
        if (claim.getBreBand().isTotalLossChoUnroadworthyCheck() && !ClaimType.isCollaborationProtocol(claim.getClaimType())
