...
public class TotalLossPeriodWhereCHOSendingAndDealingPAVAndVehicleRoadworthyCheck implements IBusinessRule {
    ...
    public RuleEvaluation applyToClaim(Claim claim) {
        ...
        if (claim.getBreBand().isTotalLossChoRoadworthyCheck() && !ClaimType.isCollaborationProtocol(claim.getClaimType())
