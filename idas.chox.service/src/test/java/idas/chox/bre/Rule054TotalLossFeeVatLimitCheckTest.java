...
import idas.chox.service.bre.rules.TotalLossFeeVatLimitCheck;
 ...
 */
public class Rule054TotalLossFeeVatLimitCheckTest extends BaseTest {
    ...
    public void testSkipped_1() throws IOException {
        ...
        claim.getBreBand().setTotalLossFeeVatLimitCheck(false);
