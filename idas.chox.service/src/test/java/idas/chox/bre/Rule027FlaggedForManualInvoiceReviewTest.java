...
import idas.chox.service.bre.rules.FlaggedForManualInvoiceReview;
...
public class Rule027FlaggedForManualInvoiceReviewTest extends TestCase {
    ...
    public void testFailled() throws IOException {
        ...
        assertTrue(rv.getRelatedRule().getNarrative().equalsIgnoreCase("The claim was marked for a manual invoice review at the claim notification stage."));
        assertTrue(rv.getRelatedRule().getStatusAfterFailure(claim.getClaimType()).equals(ClaimStatus.INVOICE_ESCALATED_TO_CH));
        assertFalse(rv.getIsVisibleToCHO());
