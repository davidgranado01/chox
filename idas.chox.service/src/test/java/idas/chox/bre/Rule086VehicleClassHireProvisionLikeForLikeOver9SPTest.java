...
import idas.chox.service.bre.rules.VehicleClassHireProvisionLikeForLikeOver9SP;
 ...
 */
public class Rule086VehicleClassHireProvisionLikeForLikeOver9SPTest extends BaseTest {
    ...
    public void testSkipped_1() throws IOException {
        ...
        claim.getBreBand().setVehicleClassHireProvisionLikeForLikeOver9SP(false);
        VehicleClassHireProvisionLikeForLikeOver9SP rule = new VehicleClassHireProvisionLikeForLikeOver9SP();
    ...
    public void testSkipped_2() throws IOException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setVehicleClassHireProvisionLikeForLikeOver9SP(true);
    ...
    public void testSkipped_4() throws IOException {
       ...
       /*
        * Customer Cannot compare non-prestige vehicle.
        */
    ...
    public void testFailed() throws IOException {
        ...
        assertTrue(rv.getRelatedRule().getNarrative().equalsIgnoreCase("The CHO's customer's vehicle is 9 years old and vehicle class SP1, please review the replacement vehicle class of SP1 on an individual basis as per the agreement in place."));
        assertTrue(rv.getRelatedRule().getStatusAfterFailure(claim.getClaimType()).equals(ClaimStatus.INVOICE_ESCALATED_TO_CH));
        assertFalse(rv.getIsVisibleToCHO());
