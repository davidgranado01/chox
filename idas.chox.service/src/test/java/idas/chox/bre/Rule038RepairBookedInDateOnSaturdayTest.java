...
import idas.chox.service.bre.rules.RepairBookedInDateOnSaturday;
...
public class Rule038RepairBookedInDateOnSaturdayTest extends TestCase {
    ...
    public void testSkipped_OnOffFlag() throws IOException {
        ...
        claim.getBreBand().setRepairBookedInDateOnSaturday(false);
    ...
    public void testPassed() throws IOException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setRepairBookedInDateOnSaturday(true);
    ...
    public void testFailled() throws IOException {
        ...
        assertTrue(rv.getRelatedRule().getNarrative().equalsIgnoreCase("Repair booked in on Saturday and the CHO's Customer's vehicle was driveable."));
        assertTrue(rv.getRelatedRule().getStatusAfterFailure(claim.getClaimType()).equals(ClaimStatus.INVOICE_ESCALATED_TO_CH));
        assertFalse(rv.getIsVisibleToCHO());
