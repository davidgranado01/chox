...
import idas.chox.service.bre.rules.GtaAmendTotalLossCHORoadworthyCheck;
...
public class Rule103GtaAmendTotalLossCHORoadworthyCheck extends BaseTest {
    ...
    public void testSkipped_OnOffFlag() throws IOException {
        ...
        RuleEvaluation rv = new GtaAmendTotalLossCHORoadworthyCheck().applyToClaim(claim);
    ...
    public void testSkipped_WhoIsSendingPav() throws IOException {
        ...
        rv = new GtaAmendTotalLossCHORoadworthyCheck().applyToClaim(claim);
        Assert.assertTrue(RuleEvaluationResult.RULE_SKIPPED == rv.getResult());
    }
    ...
    public void testPassed_HireStartJulyFirst() throws IOException, ParseException {
        ...
        GtaAmendTotalLossCHORoadworthyCheck rule = new GtaAmendTotalLossCHORoadworthyCheck();
