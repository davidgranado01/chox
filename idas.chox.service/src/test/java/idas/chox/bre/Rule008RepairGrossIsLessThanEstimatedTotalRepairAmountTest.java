...
import idas.chox.service.bre.rules.RepairGrossIsLessThanEstimatedTotalRepairAmount;
...
public class Rule008RepairGrossIsLessThanEstimatedTotalRepairAmountTest extends TestCase {
    ...
    public void testPassed_EstimatedTotalRepairAmountIsZero() throws IOException {
        ...
        claim.getEngineerReport().setTotalAmount(new BigDecimal("0.00"));
    ...
    public void testFailled_EstimatedTotalRepairAmountIsZero() throws IOException {
        ...
        // SET ENGINEERING REPORT
        claim.getEngineerReport().setTotalAmount(new BigDecimal("0"));
    ...
    public void testFailled_EstimatedTotalRepairAmountNoZero_morethan() throws IOException {
        ...
        // SET ENGINEERING REPORT
        claim.getEngineerReport().setTotalAmount(new BigDecimal("100.00"));
