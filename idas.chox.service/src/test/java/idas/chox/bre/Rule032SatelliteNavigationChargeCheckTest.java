...
import idas.chox.service.bre.rules.SatelliteNavigationChargeCheck;
...
public class Rule032SatelliteNavigationChargeCheckTest extends TestCase {
    ...
    public void testSkipped_OnOffFlag() throws IOException {
        ...
        claim.getBreBand().setSatelliteNavigationChargeCheck(false);
    ...
    public void testPassed_zero() throws IOException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setSatelliteNavigationChargeCheck(true);
    ...
    public void testPassed_negative() throws IOException {
        ...
        assertTrue(RuleEvaluationResult.RulePassed == rv.getResult());
        assertTrue(rv.getRelatedRule().getNarrative().equalsIgnoreCase(""));
        assertTrue(rv.getRelatedRule().getStatusAfterFailure().equals(ClaimStatus.INVOICE_ESCALATED_TO_CH));
        assertFalse(rv.getIsVisibleToCHO());
