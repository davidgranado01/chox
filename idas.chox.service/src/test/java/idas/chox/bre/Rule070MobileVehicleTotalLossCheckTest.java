 ...
 */
public class Rule070MobileVehicleTotalLossCheckTest extends BaseTest {
    ...
    public void testSkipped_1() throws IOException {
        ...
        claim.getBreBand().setMobileVehicleTotalLossCheck(false);
        MobileVehicleTotalLossCheck rule = new MobileVehicleTotalLossCheck();
    ...
    public void testPassed_1() throws IOException {
        Claim claim = getTestClaim();
        claim.getBreBand().setMobileVehicleTotalLossCheck(true);

        claim.getCustomer().setIsTotalLoss(Boolean.FALSE);
        claim.getCustomer().setIsUsable(Boolean.TRUE);
    ...
    public void testPassed_2() throws IOException {
        ...
        claim.getCustomer().setIsTotalLoss(Boolean.FALSE);
        claim.getCustomer().setIsUsable(Boolean.FALSE);
