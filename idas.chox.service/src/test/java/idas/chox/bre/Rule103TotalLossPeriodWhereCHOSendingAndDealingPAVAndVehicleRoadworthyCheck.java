...
import idas.chox.service.bre.rules.TotalLossPeriodWhereCHOSendingAndDealingPAVAndVehicleRoadworthyCheck;
...
public class Rule103TotalLossPeriodWhereCHOSendingAndDealingPAVAndVehicleRoadworthyCheck extends BaseTest {
    ...
    private Claim getTestClaim(){
        ...
        claim.getBreBand().setTotalLossChoRoadworthyCheck(true);
        ...
        claim.getBreBand().setTimeToAuthoriseRepair3(10);
        claim.getBreBand().setTimeToSubmittEngineersReport3(10);
        claim.getBreBand().setTimeToOffHire3(10);
        claim.getBreBand().setTotalAllowableDays3(10);
    ...
    public void testSkipped_OnOffFlag() throws IOException {
        ...
        claim.getBreBand().setTotalLossChoRoadworthyCheck(false);
        RuleEvaluation rv = new TotalLossPeriodWhereCHOSendingAndDealingPAVAndVehicleRoadworthyCheck().applyToClaim(claim);
    ...
    public void testSkipped_WhoIsSendingPav() throws IOException {
        ...
        rv = new TotalLossPeriodWhereCHOSendingAndDealingPAVAndVehicleRoadworthyCheck().applyToClaim(claim);
        Assert.assertTrue(RuleEvaluationResult.RULE_SKIPPED == rv.getResult());
    }
    ...
    public void testPassed_HireStartJulyFirst() throws IOException, ParseException {
        ...
        TotalLossPeriodWhereCHOSendingAndDealingPAVAndVehicleRoadworthyCheck rule = new TotalLossPeriodWhereCHOSendingAndDealingPAVAndVehicleRoadworthyCheck();
    ...
    public void testPassed_HireStartToHireEnd() throws IOException, ParseException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setTotalAllowableDays3(3);  //Sets Hire Star to Hire End allowed days so that it is within the limit
    ...
    public void testFailed_HireStartToHireEnd() throws IOException, ParseException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setTotalAllowableDays3(3);  //Sets Hire Star to Hire End allowed days so that it exceeds the limit
        ...
        Assert.assertTrue(rv.getRelatedRule().getNarrative().equalsIgnoreCase("The hire period for a total loss exceeds the number of days allowed where the CHO is sending PAV and the vehicle is roadworthy."));
        Assert.assertFalse(rv.getIsVisibleToCHO());
    }
    ...
    public void testPassed_DateRepairAuthorisedToEngineersReportSent() throws IOException, ParseException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setTimeToSubmittEngineersReport3(3); //Set Date Repair Authorised to Date Engineers Report sent so that it is within the limit
    ...
    public void testFailed_DateRepairAuthorisedToEngineersReportSent() throws IOException, ParseException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setTimeToSubmittEngineersReport3(3); //Set Date Repair Authorised to Date Engineers Report sent so that it exceeds the limit
    ...
    public void testPassed_HireStartToDateRepairAuthorised() throws IOException, ParseException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setTimeToAuthoriseRepair3(3); //Set Hire Start to Date Repair Authorised so that it is within the limit
    ...
    public void testFailed_HireStartToDateRepairAuthorised() throws IOException, ParseException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setTimeToAuthoriseRepair3(3); //Set Hire Start to Date Repair Authorised so that it exceeds the limit
    ...
    public void testPassed_DateRepairAuthorisedToHireEnd() throws IOException, ParseException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setTimeToOffHire3(3); //Set Date Repair Authorised to Hire End so that it is within the limit
    ...
    public void testFailed_DateRepairAuthorisedToHireEnd() throws IOException, ParseException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setTimeToOffHire3(3); //Set Date Repair Authorised to Hire End so that it exceeds the limit
