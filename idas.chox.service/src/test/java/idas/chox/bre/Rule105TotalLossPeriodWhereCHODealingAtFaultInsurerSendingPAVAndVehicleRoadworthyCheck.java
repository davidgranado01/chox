...
import idas.chox.service.bre.rules.TotalLossPeriodWhereCHODealingAtFaultInsurerSendingPAVAndVehicleRoadworthyCheck;
...
public class Rule105TotalLossPeriodWhereCHODealingAtFaultInsurerSendingPAVAndVehicleRoadworthyCheck extends BaseTest {
    ...
    public void testSkipped_OnOffFlag() throws IOException {
        ...
        RuleEvaluation rv = new TotalLossPeriodWhereCHODealingAtFaultInsurerSendingPAVAndVehicleRoadworthyCheck().applyToClaim(claim);
    ...
    public void testSkipped_WhoIsSendingPav() throws IOException {
        ...
        rv = new TotalLossPeriodWhereCHODealingAtFaultInsurerSendingPAVAndVehicleRoadworthyCheck().applyToClaim(claim);
        Assert.assertTrue(RuleEvaluationResult.RULE_SKIPPED == rv.getResult());
    }
    ...
    public void testPassed_HireStartJulyFirst() throws IOException, ParseException {
        ...
        TotalLossPeriodWhereCHODealingAtFaultInsurerSendingPAVAndVehicleRoadworthyCheck rule = new TotalLossPeriodWhereCHODealingAtFaultInsurerSendingPAVAndVehicleRoadworthyCheck();
