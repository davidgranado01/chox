...
import idas.chox.service.bre.rules.HandlingInvoiceAmountAddedToDeductionForHandlingFeeEqualsZero;
...
public class Rule018HandlingInvoiceAmountAddedToDeductionForHandlingFeeEqualsZeroTest extends TestCase {
    ...
    public void testPassed() throws IOException {
        ...
        claim.getInvoice().setDeductionForClaimsHandlingFee(new BigDecimal("-15.00"));
    ...
    public void testFailled() throws IOException {
        ...
        // SET INVOICE
        claim.getInvoice().setClaimsHandlingInvoiceAmount(new BigDecimal("15.00"));
        claim.getInvoice().setDeductionForClaimsHandlingFee(new BigDecimal("-16.00"));
