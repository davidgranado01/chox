...
import idas.chox.service.bre.rules.DeliveryOrCollectionChargeCheck;
...
public class Rule036DeliveryOrCollectionChargeCheckTest extends TestCase {
    ...
    public void testSkipped_OnOffFlag() throws IOException {
        ...
        claim.getBreBand().setDeliveryOrCollectionChargeCheck(false);
    ...
    public void testPassed_zero() throws IOException {
        ...
        Claim claim = getTestClaim();
        claim.getBreBand().setDeliveryOrCollectionChargeCheck(true);
