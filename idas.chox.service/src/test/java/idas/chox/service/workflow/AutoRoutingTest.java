...
public class AutoRoutingTest {
    ...
    public void testAutoRoutingWithInvalidStatus() throws Exception {
        ...
        Activity activity = activityFactory.getActivity("autoRouting");
    ...
    public void testAutoRouting() throws Throwable {
        ...
        AutoRouting activity = (AutoRouting) activityFactory.getActivity("autoRouting");
