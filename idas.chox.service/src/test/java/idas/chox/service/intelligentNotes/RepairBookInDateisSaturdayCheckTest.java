...
public class RepairBookInDateisSaturdayCheckTest {
    
    @Test
    // Repair book in date is Saturday.
    public void testRepairBookInDateisSaturdayCheckPass() {
        Claim c = new Claim();
        ...
        Assert.assertTrue((new RepairBookInDateisSaturdayCheck()).isShowingFor(c));
    }

    @Test
    // Repair book in date is Friday.
    public void testRepairBookInDateisSaturdayCheckFail() {
        Claim c = new Claim();
        HireMonitoringDetail hireMonitoringDetail = new HireMonitoringDetail();
        Customer customer = new Customer();
        ...
        Assert.assertFalse((new RepairBookInDateisSaturdayCheck()).isShowingFor(c));
    }
}
