...
$$
    ...
    BEGIN
        SELECT id from chorganisation where name = 'Manual Auxillis' INTO var_manual_auxillis;
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
            ...
            SELECT var_ver, var_B1, var_motability, var_manual_auxillis, 32.67, var_date_motability, 999, now(), 999, now(), 99.00
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_B2, var_motability, var_manual_auxillis, 38.16, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_B3, var_motability, var_manual_auxillis, 53.80, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_B4, var_motability, var_manual_auxillis, 64.79, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_B5, var_motability, var_manual_auxillis, 75.71, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_B6, var_motability, var_manual_auxillis, 76.86, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CM1, var_motability, var_manual_auxillis, 63.55, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CM2, var_motability, var_manual_auxillis, 73.53, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CM3, var_motability, var_manual_auxillis, 83.29, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CP1, var_motability, var_manual_auxillis, 48.88, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CP2, var_motability, var_manual_auxillis, 55.45, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CP3, var_motability, var_manual_auxillis, 63.14, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CS1, var_motability, var_manual_auxillis, 57.37, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CS2, var_motability, var_manual_auxillis, 61.35, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CS3, var_motability, var_manual_auxillis, 65.89, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CS4, var_motability, var_manual_auxillis, 69.86, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CS5, var_motability, var_manual_auxillis, 74.39, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CV1, var_motability, var_manual_auxillis, 51.96, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CV2, var_motability, var_manual_auxillis, 53.31, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CV3, var_motability, var_manual_auxillis, 56.04, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_CV4, var_motability, var_manual_auxillis, 79.84, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_F1, var_motability, var_manual_auxillis, 87.83, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_F2, var_motability, var_manual_auxillis, 94.11, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_F3, var_motability, var_manual_auxillis, 101.44, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_F4, var_motability, var_manual_auxillis, 124.44, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_F5, var_motability, var_manual_auxillis, 167.30, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_F6, var_motability, var_manual_auxillis, 188.23, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_F7, var_motability, var_manual_auxillis, 219.59, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_F8, var_motability, var_manual_auxillis, 235.28, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_F9, var_motability, var_manual_auxillis, 287.56, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_M, var_motability, var_manual_auxillis, 47.49, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_M1, var_motability, var_manual_auxillis, 54.89, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_M2, var_motability, var_manual_auxillis, 62.59, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_M3, var_motability, var_manual_auxillis, 73.57, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_M4, var_motability, var_manual_auxillis, 93.33, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_M5, var_motability, var_manual_auxillis, 139.99, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_M6, var_motability, var_manual_auxillis, 177.32, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P1, var_motability, var_manual_auxillis, 73.20, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P10, var_motability, var_manual_auxillis, 281.13, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P11, var_motability, var_manual_auxillis, 394.87, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P12, var_motability, var_manual_auxillis, 591.07, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P13, var_motability, var_manual_auxillis, 857.04, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P2, var_motability, var_manual_auxillis, 81.57, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P3, var_motability, var_manual_auxillis, 86.79, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P4, var_motability, var_manual_auxillis, 105.61, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P5, var_motability, var_manual_auxillis, 131.76, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P6, var_motability, var_manual_auxillis, 149.02, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P7, var_motability, var_manual_auxillis, 173.84, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P8, var_motability, var_manual_auxillis, 198.66, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_P9, var_motability, var_manual_auxillis, 228.47, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_PT13, var_motability, var_manual_auxillis, 298.01, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_PT9, var_motability, var_manual_auxillis, 209.12, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_PV1, var_motability, var_manual_auxillis, 35.92, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_PV2, var_motability, var_manual_auxillis, 41.69, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_PV3, var_motability, var_manual_auxillis, 41.69, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_PV4, var_motability, var_manual_auxillis, 46.22, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_PV5, var_motability, var_manual_auxillis, 48.56, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_PV6, var_motability, var_manual_auxillis, 50.90, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_RV1, var_motability, var_manual_auxillis, 69.42, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_RV2, var_motability, var_manual_auxillis, 96.01, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_S1, var_motability, var_manual_auxillis, 29.73, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_S2, var_motability, var_manual_auxillis, 33.71, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_S3, var_motability, var_manual_auxillis, 35.95, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_S4, var_motability, var_manual_auxillis, 38.55, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_S5, var_motability, var_manual_auxillis, 40.78, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_S6, var_motability, var_manual_auxillis, 43.45, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_S7, var_motability, var_manual_auxillis, 60.92, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP1, var_motability, var_manual_auxillis, 70.46, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP10, var_motability, var_manual_auxillis, 255.79, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP11, var_motability, var_manual_auxillis, 307.94, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP12, var_motability, var_manual_auxillis, 404.82, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP13, var_motability, var_manual_auxillis, 591.07, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP2, var_motability, var_manual_auxillis, 82.35, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP3, var_motability, var_manual_auxillis, 92.02, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP4, var_motability, var_manual_auxillis, 112.94, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP5, var_motability, var_manual_auxillis, 123.39, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP6, var_motability, var_manual_auxillis, 163.91, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP7, var_motability, var_manual_auxillis, 183.78, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP8, var_motability, var_manual_auxillis, 203.65, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_SP9, var_motability, var_manual_auxillis, 223.52, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_T10, var_motability, var_manual_auxillis, 156.86, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_T12, var_motability, var_manual_auxillis, 182.99, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_T14, var_motability, var_manual_auxillis, 75.29, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_T6, var_motability, var_manual_auxillis, 71.11, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_T7, var_motability, var_manual_auxillis, 57.52, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
        ...
        INSERT INTO vehicle_class_price_special_rate (version, vehicle_class_id, insurer_id, chorganisation_id, price,
                                                      start_date, created_by, created_date, last_modified_by,
                                                      last_modified_date, age)
            SELECT var_ver, var_T8, var_motability, var_manual_auxillis, 78.17, var_date_motability, 999, now(), 999, now(), 99.00
            WHERE NOT EXISTS(SELECT id
                             FROM vehicle_class_price_special_rate
