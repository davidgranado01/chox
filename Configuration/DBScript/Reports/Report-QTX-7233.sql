...
claim_type.claim_type_string as claim_type, 
--claim.liability_status, 
--values hard coded in das.chox.core/src/main/java/idas/chox/core/model/LiabilityStatus.java
CASE WHEN claim.liability_status=1 THEN 'Full Liability Accepted'
     WHEN claim.liability_status=2 THEN 'Liability In Negotiation'
     WHEN claim.liability_status=3 THEN 'Liability Unknown'
     WHEN claim.liability_status=4 THEN 'Liability Repudiated'
...
invoice.hire_net,  
invoice.hire_gross,  
invoice_original.repair_net as original_repair_net, 
invoice_original.repair_gross as original_repair_gross, 
invoice.repair_net, 
