...
-- THis includes the ECD Update fields
...
SELECT  'ROLE_CHO_MGT', 2, (Select id from accessibility WHERE name = 'activity.EcdUpdate.ContestedInvoiceReferredToCHO' AND claim_type = 17)
WHERE NOT EXISTS
(SELECT accessibility.id FROM accessibility WHERE name='activity.EcdUpdate.ContestedInvoiceReferredToCHO');
...
INSERT INTO accessibility_item(accessibility_id, role, access_right)
       ...
       AND
           NOT EXISTS (
               SELECT accessibility_item.id FROM accessibility_item, accessibility WHERE accessibility_id = accessibility.id AND role='ROLE_ALL' and access_right='1' AND accessibility.name='activity.EcdUpdate.ContestedInvoiceReferredToCHO' AND claim_type = 17
           );
...
INSERT INTO accessibility_item(accessibility_id, role, access_right)
           ...
           AND
               NOT EXISTS (
                   SELECT accessibility_item.id FROM accessibility_item, accessibility WHERE accessibility_id = accessibility.id AND role='ROLE_INS' and access_right='1' AND accessibility.name='activity.EcdUpdate.ContestedInvoiceReferredToCHO' AND claim_type =17
               );

INSERT INTO accessibility_item(accessibility_id, role, access_right)
       SELECT id, 'ROLE_CHO_MNG', 2  FROM accessibility WHERE name='activity.EcdUpdate.ContestedInvoiceReferredToCHO' AND claim_type = 17
    AND
        NOT EXISTS (
            SELECT accessibility_item.id FROM accessibility_item, accessibility WHERE accessibility_id = accessibility.id AND role='ROLE_CHO_MNG' and access_right='2' AND accessibility.name='activity.EcdUpdate.ContestedInvoiceReferredToCHO' AND claim_type = 17
        );

INSERT INTO accessibility_item(accessibility_id, role, access_right)
           SELECT id, 'ROLE_CHO_OPR', 2  FROM accessibility WHERE name='activity.EcdUpdate.ContestedInvoiceReferredToCHO' AND  claim_type =17
        AND
            NOT EXISTS (
                SELECT accessibility_item.id FROM accessibility_item, accessibility WHERE accessibility_id = accessibility.id AND role='ROLE_CHO_OPR' and access_right='2' AND accessibility.name='activity.EcdUpdate.ContestedInvoiceReferredToCHO' AND claim_type =17
            );

INSERT INTO accessibility_item(accessibility_id, role, access_right)
          SELECT id, 'ROLE_ALL', 1  FROM accessibility WHERE name='activity.EcdUpdate.ContestedInvoiceReferredToCHO' AND claim_type = 17
       AND
           NOT EXISTS (
               SELECT accessibility_item.id FROM accessibility_item, accessibility WHERE accessibility_id = accessibility.id AND role='ROLE_ALL' and access_right='1' AND accessibility.name='activity.EcdUpdate.ContestedInvoiceReferredToCHO' AND claim_type = 17
           );
...
INSERT INTO accessibility_item(accessibility_id, role, access_right)
              SELECT id, 'ROLE_INS', 1  FROM accessibility WHERE name='activity.EcdUpdate.ContestedInvoiceReferredToCHO' AND  claim_type =17
           AND
               NOT EXISTS (
                   SELECT accessibility_item.id FROM accessibility_item, accessibility WHERE accessibility_id = accessibility.id AND role='ROLE_INS' and access_right='1' AND accessibility.name='activity.EcdUpdate.ContestedInvoiceReferredToCHO' AND claim_type =17
               );
