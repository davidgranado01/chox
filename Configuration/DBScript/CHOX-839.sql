...
BEGIN
    ...
    where status = true and last_login_date < cutOff
      and user_name not like 'admin@%' and user_name not in ('ecdupdate@erac.com','erac_scheduler','easidrive_scheduler','ecdupdate@aiclaimssolutions.com','paidInvoices.rsa','paidinvoices.qbe','system','acknowledgeclaims.dlg','acknowledgeClaims.dlg','erac_scheduler','claimMatcher.lv','paidInvoices.lv');
