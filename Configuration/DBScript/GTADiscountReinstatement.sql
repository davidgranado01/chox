--
-- GTA Discount Reinstatement Sprint
--

-- UAT
insert into gmail_scheduler_job (version, login_username, login_password, job_name, email_subject,
            authorised_user, bcc_receiver, processed_label, error_message_receiver, active, reply_to_sender,
            created_by, created_date, last_modified_by, last_modified_date)
    select 0, 'easidrive_scheduler', 'C0mpliance', 'attachmentUpload', 'Easidrive: Attachment Upload',
            'John.Strawhorne@audatex.co.uk,John.Dowson@audatex.co.uk,robert.hon@audatex.co.uk,Melvin.Lai@audatex.co.uk', 'john.dowson@valexa.com', 'Processed Attachment Upload',
            'john.dowson@valexa.com', true, true, 999, now(), 999, now();
...
insert into gmail_scheduler_job (version, login_username, login_password, job_name, email_subject,
            ...
            created_by, created_date, last_modified_by, last_modified_date)
    select 0, 'easidrive_scheduler', 'C0mpliance, 'attachmentUpload', 'Easidrive: Attachment Upload',
            'sean.quine@garvins-solicitors.com,Caroline.Smith@garvins-solicitors.com,Mellissa.Austin@garvins-solicitors.com,Matthew.Harrington@garvins-solicitors.com,Mellissa.Austin@easidrive.com,Josh.Pownall@easidrive.com,Dawn.Cooke@easidrive.com,John.Westall@easidrive.com,Amber.Colman@easidrive.com', 'john.dowson@valexa.com', 'Processed Attachment Upload',
            'john.dowson@valexa.com', true, true, 999, now(), 999, now();

--
-- CHOX-417: Add Blank Labour Rate BRE Rule
--
ALTER TABLE bre_band ADD COLUMN blank_labour_rate_check Boolean NOT NULL Default FALSE;

--
-- CHOX-651: GTA Discount Re-instatement
--
ALTER TABLE invoice ADD COLUMN gta_discount_start timestamp without time zone;
