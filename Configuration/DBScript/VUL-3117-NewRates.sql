...
DECLARE var_motability integer; --19 
DECLARE var_tesco integer; --27
DECLARE var_ers integer; --20
...
SELECT id from insurer where name = 'RSA' INTO var_rsa;
SELECT id from insurer where name = 'Motability' INTO var_motability;
SELECT id from insurer where name = 'Tesco UW' INTO var_tesco;
SELECT id from insurer where name = 'ERS Claims Limited' INTO var_ers;
