...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var hireMonitoringDetailsDisabled = invoiceDetailTabAccessibility == 0;
            var invoiceDetailsDisabled = hireMonitoringTabAccessibility == 0;
            var paymentPackDisabled = historyTabAccessibility == 0;
            var historyDetailsDisabled = notesTabAccessibility == 0;
