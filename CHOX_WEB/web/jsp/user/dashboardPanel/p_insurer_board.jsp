...
<script>
    ...
    Ext.onReady(function(){
        ...
        new Ext.ToolTip({target: 'tip15',html: 'Description for Total Value of Penalty Charges Applied'});                
        Ext.QuickTips.init();
});    
...
<table cellpadding="0" cellspacing="0" class="dashboard" style="width:99%;" border="0">
    ...
    <tr><th nowrap>Total Value of Penalty Charges Applied<img class="tip-target" alt="" src="<%=request.getContextPath()%>/images/tip.png"  id="tip15"/></th>	<td><label class="std-data-ro">£<s:property value="w2DData.totalValueOfPenaltyChargesApplied"/></label></td>	<td><label class="std-data-ro">£<s:property value="m2DData.totalValueOfPenaltyChargesApplied"/></label></td>	<td><label class="std-data-ro">£<s:property value="cData.totalValueOfPenaltyChargesApplied"/></label></td></tr>    
</table>
