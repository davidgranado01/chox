    ...
    <fieldset class="x-fieldset">
        ...
        <div style="display:none" class="form-container">
            <div class="chox-form-item">
                ...
                CDW Fee<span class="mandatory">*</span></label>
            <input type="text" class="chox-ttnum"  name="cdwFee" value='<s:property value="cdwFee" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                CDW Quantity<span class="mandatory">*</span></label>
            <input type="text" class="chox-ttnum"  name="cdwQty" value='<s:property value="cdwQty" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                Automatic Fee<span class="mandatory">*</span></label>
            <input type="text" class="chox-ttnum"  name="automaticFee" value='<s:property value="automaticFee" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                Automatic Quantity<span class="mandatory">*</span></label>
            <input type="text" class="chox-ttnum"  name="automaticQty" value='<s:property value="automaticQty" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                Sat Nav Fee<span class="mandatory">*</span></label>
            <input type="text" class="chox-ttnum"  name="satNavFee" value='<s:property value="satNavFee" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                Sat Nav Quantity<span class="mandatory">*</span></label>
            <input type="text" class="chox-ttnum"  name="satNavQty" value='<s:property value="satNavQty" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                Estate Fee<span class="mandatory">*</span></label>
            <input type="text" class="chox-ttnum"  name="estateFee" value='<s:property value="estateFee" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                Estate Quantity<span class="mandatory">*</span></label>
            <input type="text" class="chox-ttnum"  name="estateQty" value='<s:property value="estateQty" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                Baby Seat Fee<span class="mandatory">*</span></label>
            <input type="text" class="chox-ttnum"  name="babySeatFee" value='<s:property value="babySeatFee" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                    Baby Seat Quantity<span class="mandatory">*</span>
                </label>
            <input type="text" class="chox-ttnum"  name="babySeatQty" value='<s:property value="babySeatQty" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                Tow Bars Fee<span class="mandatory">*</span></label>
            <input type="text" class="chox-ttnum"  name="towBarsFee" value='<s:property value="towBarsFee" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                Tow Bars Quantity<span class="mandatory">*</span></label>
            <input type="text" class="chox-ttnum"  name="towBarsQty" value='<s:property value="towBarsQty" />'/></div>
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                Non-standard Risk Ins. Premium Fee<span class="mandatory">*</span></label>
            ...
            <div class="chox-form-item">
                <label class="chox-form-std-label">
                Non-standard Risk Ins. Premium Qty<span class="mandatory">*</span></label>
