...
public class BaseActivityEvent extends Entity implements Serializable {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(BaseActivityEvent.class);
    ...
    protected void addAllClaimAttributes(Claim claim) {
        ...
        addClaimHireMonitoringEcdAttributes(claim);
    }
    ...
    protected void addClaimAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim attributes: {}", ex.getMessage(), ex);
        }
    ...
    protected void addClaimCustomerAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim customer attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimCustomerVehicleAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim customer vehicle attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimCustomerMitigationAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim customer mittigation attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimCustomerIncidentAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim customer incident attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimCustomerIncidentWitnessAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim customer incident witness attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimCustomerIncidentInjuryAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim customer incident injury attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimCustomerIncidentInjurySolicitorAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim customer incident injusry solititor attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimThirdPartyAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim third party attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimThirdPartyVehicleAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim third party vehicle attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimEngineerReportAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim engineer report attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimHireMonitoringAttributes(Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim hire monitoring attributes: {}", ex.getMessage(), ex);
        }
    }
...
//        addClaimInsurerHireVehicleParameters(generator, claim);
            ...
            LOG.error("Exceptin thrown adding claim insurer hire monitoring attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimAuditReviewAttributes(final Claim claim) {
        try {
            ...
            if (claimAuditReview != null) {
                ...
                addAttribute("totalHireCost", claimAuditReview.getTotalHireCost() == null ? null : claimAuditReview.getTotalHireCost().toPlainString());
                addAttribute("totalRepairCost", claimAuditReview.getTotalRepairCost() == null ? null : claimAuditReview.getTotalRepairCost().toPlainString());
                addAttribute("penaltyChargesPaid", claimAuditReview.getPenaltyChargesPaid() == null ? null : claimAuditReview.getPenaltyChargesPaid().toPlainString());
                addAttribute("hireLeakageCost", claimAuditReview.getHireLeakageCost() == null ? null : claimAuditReview.getHireLeakageCost().toPlainString());
                addAttribute("exceededRepairCost", claimAuditReview.getExceededRepairCost() == null ? null : claimAuditReview.getExceededRepairCost().toPlainString());
                addAttribute("nonABPGuidelineRepairLabourRate", claimAuditReview.getNonABPGuidelineRepairLabourRate() == null ? null : claimAuditReview.getNonABPGuidelineRepairLabourRate().toPlainString());
            ...
            LOG.error("Exceptin thrown adding claim audit review attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimHireMonitoringEcdAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim hire monitoring ECD attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addClaimLiabilityAttributes(final Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding claim liability attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addInvoiceAttributes(final Claim claim) {
        try {
            ...
            if (invoice != null) {
                ...
                addAttribute("invoiceVedFee", invoice.getVedFee().toPlainString());
            ...
            LOG.error("Exceptin thrown adding invoice attributes: {}", ex.getMessage(), ex);
        }
    }
    ...
    protected void addInvoicePaidAttributes(Claim claim) {
        try {
            ...
            LOG.error("Exceptin thrown adding invoice paid attributes: {}", ex.getMessage(), ex);
        }
    }
}
