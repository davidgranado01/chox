...
((inv.hire_gross_paid + inv.hire_penalty_charge_paid) * c.percentage_liability_accepted/100.0)::numeric(8,2) as "Hire LPPs Paid",
((inv.repair_gross_paid + inv.repair_penalty_charge_paid + inv.engineer_fee_gross_paid)*c.percentage_liability_accepted/100.0)::numeric(8,2) as "Repair LPPs Paid",
