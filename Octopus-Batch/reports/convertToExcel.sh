...
RECIPIENTS_CTE_TESCO_CLAIM_REPORT=#{RECIPIENTS_CTE_TESCO_CLAIM_REPORT}
RECIPIENTS_CTE_TESCO_INVOICE_REPORT_REPORT=#{RECIPIENTS_CTE_TESCO_INVOICE_REPORT_REPORT}
...
#            EMAIL_RECEIVERS=MichaelPaul.Kemp@valexa.com;;
        ...
        "Tesco-InvoiceDetailsDump-"* )
          ACTIVE=1
            EMAIL_RECEIVERS=${RECIPIENTS_CTE_TESCO_INVOICE_REPORT_REPORT};;
