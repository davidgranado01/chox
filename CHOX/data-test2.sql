...
insert into insurer_country_alias(insurer_country_id,alias) values(1004,'NU');
...
insert into supplier_alias(supplier_id,alias) values(1000,'Drive Assist');

insert into supplier(id,name,address1,address2,address3,address4,address5,postcode,country_id,vat_no,company_no)
values (1001,'Accident Exchange Limited','Alpha 1','Canton Lane','Hams Hall','Coleshill','West Midlands','B46 1GA',1000,'TBA','04141140');

insert into supplier_alias(supplier_id,alias) values(1001,'Accident Exchange');
...
insert into web_user(id,email,firstnames,lastname,password) values(1001,'user1@idasnetwork.com','User','One','user1');
insert into web_user(id,email,firstnames,lastname,password) values(1002,'user2@idasnetwork.com','User','Two','user2');
insert into web_user(id,email,firstnames,lastname,password) values(1003,'user3@idasnetwork.com','User','Three','user3');
insert into web_user(id,email,firstnames,lastname,password) values(1004,'user4@idasnetwork.com','User','Four','user4');
insert into web_user(id,email,firstnames,lastname,password) values(1005,'user5@idasnetwork.com','User','Five','user5');
insert into web_user(id,email,firstnames,lastname,password) values(1006,'user6@idasnetwork.com','User','Six','user6');
insert into web_user(id,email,firstnames,lastname,password) values(1007,'user7@idasnetwork.com','User','Seven','user7');
insert into web_user(id,email,firstnames,lastname,password) values(1008,'user8@idasnetwork.com','User','Eight','user8');
insert into web_user(id,email,firstnames,lastname,password) values(1009,'user9@idasnetwork.com','User','Nine','user9');
insert into web_user(id,email,firstnames,lastname,password) values(1010,'user10@idasnetwork.com','User','Ten','user10');
insert into web_user(id,email,firstnames,lastname,password) values(1011,'user11@idasnetwork.com','User','Eleven','user11');
insert into web_user(id,email,firstnames,lastname,password) values(1012,'user12@idasnetwork.com','User','Twelve','user12');

insert into web_user_security(web_user_id,user_class) values(1000,'root');
insert into web_user_security(web_user_id,user_class,insurer_country_id) values(1001,'user',1000);
insert into web_user_security(web_user_id,user_class,insurer_country_id) values(1002,'user',1001);
insert into web_user_security(web_user_id,user_class,insurer_country_id) values(1003,'user',1002);
insert into web_user_security(web_user_id,user_class,insurer_country_id) values(1004,'user',1003);
insert into web_user_security(web_user_id,user_class,insurer_country_id) values(1005,'user',1004);
insert into web_user_security(web_user_id,user_class,insurer_country_id) values(1006,'user',1005);
insert into web_user_security(web_user_id,user_class,insurer_country_id) values(1007,'user',1006);

insert into web_user_security(web_user_id,user_class,supplier_id) values(1008,'user',1000);
insert into web_user_security(web_user_id,user_class,supplier_id) values(1009,'user',1001);
insert into web_user_security(web_user_id,user_class,supplier_id) values(1010,'user',999);
...
insert into rental_processor(tp_insurer_country_id,supplier_id,seq,java_class)
select ic.id,s.id,0,'chox.processor.CatchAllRentalProcessor' from insurer_country ic,supplier s;
