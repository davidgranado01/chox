...
public class QuantumAgreedNotifierTest extends AbstractNotifierTest {

    private @Autowired QuantumAgreedNotifier notifier;

    public QuantumAgreedNotifierTest() throws Exception {
        super();
    }
