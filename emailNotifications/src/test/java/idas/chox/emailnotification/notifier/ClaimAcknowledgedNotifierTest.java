...
public class ClaimAcknowledgedNotifierTest extends AbstractNotifierTest {

    private @Autowired ClaimAcknowledgedNotifier notifier;

    public ClaimAcknowledgedNotifierTest() throws Exception {
        super();
    }
