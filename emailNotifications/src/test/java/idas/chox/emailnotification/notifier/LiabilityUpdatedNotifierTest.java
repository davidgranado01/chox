...
public class LiabilityUpdatedNotifierTest extends AbstractNotifierTest {

    private @Autowired LiabilityUpdatedNotifier notifier;

    public LiabilityUpdatedNotifierTest() throws Exception {
        super();
    }
