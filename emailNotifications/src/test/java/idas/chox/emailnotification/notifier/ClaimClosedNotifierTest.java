...
public class ClaimClosedNotifierTest extends AbstractNotifierTest {
    ...
    private @Autowired ClaimClosedNotifier notifier;

    public ClaimClosedNotifierTest() throws Exception {
        super();
    }
...
//        notifier.getAndProcessNotificationData(getSettings(), defaultFrom, defaultTo, true);
    ...
    public NotificationSettingsBean getSettings() {
        NotificationSettingsBean settings = new NotificationSettingsBean("6:1123:CLOSED:test@valexa.com");
        return settings;
    }
