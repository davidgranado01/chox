...
public class InvoicePaidNotifier extends AbstractNotifier implements Notifier {
    ...
    protected static final String TEMPLATE_LOCATION = "templates/invoice_paid_manual_claim_notification.vm";
    protected static final String SUBJECT = "%s Supplier Reference: %s Invoice Paid Notification";
