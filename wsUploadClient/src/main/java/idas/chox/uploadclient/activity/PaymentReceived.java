        ...
        if (filename.exists()) {
            ...
            try {
                ...
                while ((choReference = br.readLine()) != null) {
                    updateClaimToPaymentReceived(uploadService, choReference);
                }
            ...
            updateClaimToPaymentReceived(uploadService, file);
        }

    }

    public static void updateClaimToPaymentReceived(UploadService uploadService, String choReference) {
        Result result = null;
