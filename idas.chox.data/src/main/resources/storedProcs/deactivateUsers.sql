...
DECLARE
    ...
    BEGIN
        ...
        where status = true and last_login_date < cutOff
          and user_name not like 'admin@%' and id not in (999, 4391, 5454, 3757, 6410, 3893, 6148, 5002, 5, 2002, 1766, 6637, 5075, 46, 4878, 1767, 3191, 6694, 6747, 6693, 7243, 7828, 7435);
