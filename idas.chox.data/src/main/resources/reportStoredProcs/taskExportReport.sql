 ...
 RETURN QUERY
  ...
  from 
    task t left outer join claim c on (c.id = t.claim_id)
           ...
           left outer join audit_trail a on (a.claim_id = c.id)
  where 
    t.complete = false 
