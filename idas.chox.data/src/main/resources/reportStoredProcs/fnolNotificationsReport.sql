...
select c.cho_reference as supplier_reference, ins.name, 'Claim Accepted' as claim_status,  getLiabilityStatus(c.liability_status),
...
select c.cho_reference as supplier_reference, ins.name, 'Claim Rejected' as claim_status,  getLiabilityStatus(c.liability_status),
