-- DROP FUNCTION monthlyBREReviewReportSummary(IN start_date text, IN end_date text, IN claimTypes integer[], IN choIds  integer[], IN insIds integer[]);
-- select * from monthlyBREReviewReportSummary('2011-01-01','2014-01-01', array[]::integer[], array[]::integer[], array[6]);
CREATE OR REPLACE FUNCTION monthlyBREReviewReportSummary(
    IN start_date text, 
    IN end_date text, 
...
GRANT EXECUTE ON FUNCTION monthlyBREReviewReportSummary(IN start_date text, IN end_date text, IN claimTypes integer[], IN choIds  integer[], IN insIds integer[]) TO chox_user;
GRANT EXECUTE ON FUNCTION monthlyBREReviewReportSummary(IN start_date text, IN end_date text, IN claimTypes integer[], IN choIds  integer[], IN insIds integer[]) TO chox_mi;
