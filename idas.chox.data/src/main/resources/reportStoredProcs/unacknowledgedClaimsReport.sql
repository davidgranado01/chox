    ...
    BEGIN
        RETURN QUERY
            select c.cho_reference, cho.name, ins.name, c.claim_number, w.name, case when c.managing_repair then 'Yes'::varchar else 'No'::varchar end,
                   to_char(policy_holder_contact_date, 'dd/mm/yyyy hh24:mi:ss')::varchar, wu.user_name,
                   ...
                   tp.policy_number, tp.title, tp.first_name, tp.last_name, tp.vehicle_registration, to_char(inc.date, 'dd/mm/yyyy hh24:mi:ss')::varchar,
