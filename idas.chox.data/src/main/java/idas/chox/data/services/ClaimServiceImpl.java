...
/**
                List<Integer> bList = bCriteria.getExecutableCriteria(getSession()).list();
                
                for(Integer b : bList) {
                    LOG.info("Found BreBand with id={} [BreBand mapped to my CHO with id={}]", b, getCurrentUser().getChorganisation().getId());
                }
**/
