...
public class ClaimMatchingBandServiceImpl extends SecureDataService implements ClaimMatchingBandService {
    ...
    @Override
    public ClaimMatchingBand getClaimMatchingBand(int breBandId, ClaimType claimType, String vehicleClass, BigDecimal liabilityPercentage) {
        ...
        claimMatchingBandCriteria.add(Restrictions.ge("liabilityPercentage", liabilityPercentage));
